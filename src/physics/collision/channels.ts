...
export const CHANNEL_DEFINITIONS: Record<Channel, ChannelDefinition> = {
  mumu: { spec: { min: 2, max: 200, bins: 9900 }, defaultPtMinGeV: 3, ptMinRange: [3, 50] },
  gammagamma: { spec: { min: 80, max: 200, bins: 2400 }, defaultPtMinGeV: 30, ptMinRange: [15, 80] },
  fourlepton: { spec: { min: 70, max: 400, bins: 3300 }, defaultPtMinGeV: 7, ptMinRange: [5, 30] },
};
