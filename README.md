...
Этап 1: столкновения протонов по методу Монте-Карло, упрощённый детектор, гистограмма инвариантной массы μ⁺μ⁻ с пиками J/ψ, Υ и Z, окно масс и значимость. Ручки светимости: число сгустков, протонов в сгустке, β*.
